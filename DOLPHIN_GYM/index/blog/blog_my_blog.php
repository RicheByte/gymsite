...
<div class="container mt-5">
    <h1 class="text-center mb-4 gradient-bg">Add New Blog Post (User)</h1>
    <form action="include/blog_add.inc.php" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <!-- Replace the textarea with TinyMCE editor -->
...
<!-- Display User's Posted Blogs -->
<div class="container mt-5">
    <h2 class="text-center mb-4 gradient-bg">My Posted Blogs</h2>
    <?php
    // Fetch the current user's posts
    $username = $_SESSION['username']; // Assuming the username is stored in the session
    $query = "SELECT id, title, img, content, date, category FROM blog WHERE username = ? ORDER BY date DESC";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <p class="card-text"><small class="text-muted">Posted on: ' . date("F j, Y", strtotime($row['date'])) . ' | Category: ' . htmlspecialchars($row['category']) . '</small></p>
            ...
            echo '
                    ...
                    <form action="include/blog_delete.inc.php" method="POST" style="display: inline;">
